...
We present \textbf{Decapod}, a local-first governance kernel, as a reference implementation of this model. We propose an empirical evaluation protocol to analyze governed execution across 35 multi-step software tasks under three conditions: prompt-only baseline, checklist-disciplined baseline, and Decapod-governed treatment. We outline our evaluation plan and project how these primitives are expected to reduce false completion claims, prevent concurrent edit conflicts, and decrease developer auditing overhead.
