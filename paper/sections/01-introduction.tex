...
We present \textbf{Decapod}, a daemonless, local-first governance kernel, as a reference implementation of this model. We propose an empirical evaluation protocol to analyze whether a governed system can support natural delegation with less human procedural micromanagement. Its primary design crosses conventional and Decapod-governed execution with natural and procedural prompts; the checklist condition remains a secondary ablation. The contribution at this stage is the model, implementation mapping, and falsifiable protocol—not a measured performance result.
