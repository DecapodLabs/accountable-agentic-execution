...
\begin{enumerate}
    ...
    \item \textbf{Semantic-overlap awareness (desired, not enforced):} similar-but-distinct tasks should remain concurrent when safe and coordinate when their integration surfaces interact. Current task claims do not infer this relation automatically.
