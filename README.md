...
The implementation mapping is pinned to Decapod [`207e9a3`](https://github.com/DecapodLabs/decapod/commit/207e9a37e57ee970e881942de2994abea2cd737c) (`v0.66.3`). It verifies real task claims, trust-gated handoff, workspaces, context capsules, repository memory, governance events, proofs, and publication gates. It also records narrower boundaries: shared ownership exists, handoff does not transfer hidden conversation state, worktrees do not guarantee clean integration, and the public cloud backend is unavailable. The intervening changes from the prior `v0.66.1` audit are release, CI, and research-link documentation changes; mapped implementation paths are unchanged.
...
The adoption inventory contains **18 repositories across three owner namespaces**—15 public and three private. The authenticated audit verified public governance evidence in 17: 16 expose `.decapod/config.toml`, while the public [`alexhraber/alexhraber`](https://github.com/alexhraber/alexhraber) profile repository exposes a generated Decapod `AGENTS.md`. The author additionally identifies [`alexhraber/tensors-to-consciousness`](https://github.com/alexhraber/tensors-to-consciousness) as Decapod-enabled, although its public default branch currently exposes neither marker:

- `alexhraber`: [`alexhraber`](https://github.com/alexhraber/alexhraber), [`pi-cluster`](https://github.com/alexhraber/pi-cluster), [`builddeck`](https://github.com/alexhraber/builddeck), [`agentic-sdlc-intake-attack`](https://github.com/alexhraber/agentic-sdlc-intake-attack), [`metaplay-fake-interview-supply-chain-incident`](https://github.com/alexhraber/metaplay-fake-interview-supply-chain-incident), [`flowhawk`](https://github.com/alexhraber/flowhawk), [`tensors-to-consciousness`](https://github.com/alexhraber/tensors-to-consciousness), [`go-scaling`](https://github.com/alexhraber/go-scaling), [`nixos`](https://github.com/alexhraber/nixos), private [`cycle`](https://github.com/alexhraber/cycle), and private [`mentora-automa`](https://github.com/alexhraber/mentora-automa).
...
The profile README is the author's public researcher/engineer credential surface; that is a professional provenance claim, not cryptographic identity authentication. This is a maintainer-correlated deployment footprint, not 18 independent adopters or evidence that the governance mechanisms improve outcomes. See the [repository-use inventory and verification boundary](docs/adoption-inventory.md).
