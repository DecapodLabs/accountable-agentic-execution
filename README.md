...
[![Decapod 🦀](https://img.shields.io/badge/Decapod%20%F0%9F%A6%80-v0.66.3-dc2626?logo=gear&logoColor=white)](https://github.com/DecapodLabs/decapod)
...
The [`alexhraber/alexhraber`](https://github.com/alexhraber/alexhraber) repository is the author's public researcher and engineer profile. The `worldofgeese` maintainer discovered and adopted Decapod independently; the remaining namespaces are author- or organization-affiliated. Because repositories within each namespace share maintainers, this footprint is not evidence of 18 independent adopters or of improved outcomes. See the [repository-use inventory](docs/adoption-inventory.md).
