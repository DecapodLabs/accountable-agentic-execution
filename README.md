...
The same authenticated audit verified Decapod governance evidence in **16 repositories across three owner namespaces**—13 public and three private. Fifteen expose `.decapod/config.toml`; the public [`alexhraber/alexhraber`](https://github.com/alexhraber/alexhraber) profile repository exposes a generated Decapod `AGENTS.md`:

- `alexhraber`: [`alexhraber`](https://github.com/alexhraber/alexhraber), [`pi-cluster`](https://github.com/alexhraber/pi-cluster), [`builddeck`](https://github.com/alexhraber/builddeck), [`agentic-sdlc-intake-attack`](https://github.com/alexhraber/agentic-sdlc-intake-attack), [`metaplay-fake-interview-supply-chain-incident`](https://github.com/alexhraber/metaplay-fake-interview-supply-chain-incident), [`go-scaling`](https://github.com/alexhraber/go-scaling), [`nixos`](https://github.com/alexhraber/nixos), private [`cycle`](https://github.com/alexhraber/cycle), and private [`mentora-automa`](https://github.com/alexhraber/mentora-automa).
...
The profile README is the author's public researcher/engineer credential surface; that is a professional provenance claim, not cryptographic identity authentication. This is a maintainer-correlated deployment footprint, not 16 independent adopters or evidence that the governance mechanisms improve outcomes. See the [repository-use inventory and verification boundary](docs/adoption-inventory.md).
